...
def main():
    ...
    arg_parser.add_argument('--path', type=str, default='C:/Users/ddino/OneDrive/문서/WorkSpace/VisualStudioProjects/game-server-study/GameServer/GameDB.xml', help='Xml Path')
